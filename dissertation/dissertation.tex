...
\begin{refsection}
	...
	\makeatother
	\chapter
	 [Chapter1 Title in the Table of Contents]
	 {Full Chapter1 Title%
	  % \setcounter{footnote}{1}\textsuperscript{\Large\fnsymbol{footnote}}%
	 }
    \chaptermark{Header Title of Chapter 1}
	\label{diss:chapter1}
...
\begin{refsection}
	...
	\makeatother
	\chapter
	 [Chapter2 Title in the Table of Contents]
	 {Full Chapter2 Title%
	  % \setcounter{footnote}{1}\textsuperscript{\Large\fnsymbol{footnote}}%
	 }
    \chaptermark{Header Title of Chapter 2}
	\label{diss:chapter2}
	% Use footnote symbols instead of numbers
	\renewcommand{\thefootnote}{\fnsymbol{footnote}}
...
\begin{refsection}
	...
	\makeatother
	\chapter
	 [Chapter3 Title in the Table of Contents]
	 {Full Chapter3 Title%
	  % \setcounter{footnote}{1}\textsuperscript{\Large\fnsymbol{footnote}}%
	 }
    \chaptermark{Header Title of Chapter 3}
	\label{diss:chapter3}
	% Use footnote symbols instead of numbers
	\renewcommand{\thefootnote}{\fnsymbol{footnote}}
